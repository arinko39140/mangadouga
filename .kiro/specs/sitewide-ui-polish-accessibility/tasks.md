...
- [ ] 1.1 トークン/フォント/階層スタイルを共通化し、Reactページの基準を確立する
...
- [ ] 1.2 コントラスト基準と低コントラスト調整の方針を反映する
...
- [ ] 2. ナビゲーション共通パターンの統一
- [ ] 2.1 ナビゲーションの階層/状態/余白ルールを統一し、主要ページへ展開する
