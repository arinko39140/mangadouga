...
describe('OshiListsPage', () => {
  ...
  it('取得成功で一覧を表示する', async () => {
    ...
    const activeBadge = screen.getByText('済')
    const inactiveBadge = screen.getByText('推')
    expect(activeBadge).toBeInTheDocument()
    expect(inactiveBadge).toBeInTheDocument()
    expect(activeBadge).toHaveClass('state-badge')
    expect(inactiveBadge).toHaveClass('state-badge')
